...
export default function App() {
  ...
  const handleDeploy = async () => {
    ...
    if (chain.id !== sepolia.id) return setStatus('Error: Please switch to Sepolia.');
  ...
  return (
    <div className="container">
      <div className="header">
        ...
        {/* RainbowKit's button handles everything: connect, disconnect, show balance/address */}
        <ConnectButton />
      </div>

      {isConnected && !deployedAddress && (
      ...
      <div className="status">{!isConnected && 'Please connect your wallet to begin.'} {status}</div>
