...
// This function consistently creates a stable Ethers v5 Signer from the connected wallet
  ...
  useEffect(() => {
    const initializeFhevm = async () => {
      if (deployedAddress && walletClient) {
        ...
        try {
          // --- FINAL FIX: Use the stable signer & provider from our helper function ---
          ...
          const deployedContract = new ethers.Contract(deployedAddress, contractABI, contractBytecode, signer);
    ...
    <div className="app-wrapper">
      <div className="container">
        <div className="header">
          ...
          {/* RainbowKit's button handles connect, disconnect, balance, etc. */}
          <ConnectButton />
        </div>
